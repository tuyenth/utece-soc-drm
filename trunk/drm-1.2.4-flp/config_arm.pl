...
while(<FHI>)
{
  ...
  {
    printf FHO "DEFAULT_INCLUDES = -I. -I\$(srcdir) -I\$(top_builddir) -I$pwd/fft_inc -I/usr/include\n";
  }
  elsif(/^LIBS.*gold_arm.*/)
  {
    printf FHO "LIBS = -l$pwd/arm/fft_lib/libfftw.a -l$pwd/arm/fft_lib/librfftw.a\n";
  }
  else
  {
    print FHO $_;
...
printf FHO "make\n";
printf FHO "armcc -c -DHAVE_CONFIG_H -I$pwd/faad2/libfaad -I$pwd/faad2 -I/usr/local/packages/coware/arm-1.2/common/include/ -I/usr/include -I. -I.. ./irq.c ../config.h $pwd/faad2/libfaad/bits.c $pwd/faad2/libfaad/cfft.c $pwd/faad2/libfaad/common.c $pwd/faad2/libfaad/common_dummy.c $pwd/faad2/libfaad/decoder.c $pwd/faad2/libfaad/drc.c $pwd/faad2/libfaad/drm_dec.c $pwd/faad2/libfaad/error.c $pwd/faad2/libfaad/filtbank.c $pwd/faad2/libfaad/hcr.c $pwd/faad2/libfaad/huffman.c $pwd/faad2/libfaad/ic_predict.c $pwd/faad2/libfaad/is.c $pwd/faad2/libfaad/lt_predict.c $pwd/faad2/libfaad/mdct.c $pwd/faad2/libfaad/mp4.c $pwd/faad2/libfaad/ms.c $pwd/faad2/libfaad/output.c $pwd/faad2/libfaad/pns.c $pwd/faad2/libfaad/ps_dec.c $pwd/faad2/libfaad/ps_syntax.c $pwd/faad2/libfaad/pulse.c $pwd/faad2/libfaad/rvlc.c $pwd/faad2/libfaad/sbr_dct.c $pwd/faad2/libfaad/sbr_dec.c $pwd/faad2/libfaad/sbr_e_nf.c $pwd/faad2/libfaad/sbr_fbt.c $pwd/faad2/libfaad/sbr_hfadj.c $pwd/faad2/libfaad/sbr_hfgen.c $pwd/faad2/libfaad/sbr_huff.c $pwd/faad2/libfaad/sbr_qmf.c $pwd/faad2/libfaad/sbr_syntax.c $pwd/faad2/libfaad/sbr_tf_grid.c $pwd/faad2/libfaad/specrec.c $pwd/faad2/libfaad/ssr.c $pwd/faad2/libfaad/ssr_fb.c $pwd/faad2/libfaad/ssr_ipqf.c $pwd/faad2/libfaad/syntax.c $pwd/faad2/libfaad/tns.c\n";
